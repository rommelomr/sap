...
export let D = {
	...
	dom:{
		...
		use example:
		{
			...
			insert:{
				tag:'h5', //tago of the new element that will be created
				id:'example_2', new element's id
				attrs:{class:'examples_2',}, new element's class
				insert:{ //Content we're going to insert. Could be a string (the simple either content, or another element following the same structure)
					tag:'h4',
					id:'example_3',
